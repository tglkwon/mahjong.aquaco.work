          ...
          <div className={`${isUmaOkaSettingsExpanded ? 'contents' : 'flex flex-col lg:flex-1'} items-stretch gap-2`}>
            ...
            {isUmaOkaSettingsExpanded && (
              <div id="uma-oka-settings-panel" className="lg:col-span-3 grid grid-cols-2 sm:grid-cols-4 items-stretch gap-2">
                {(() => {
                  const commonButtonClasses = "font-semibold min-h-[96px] h-full py-2 px-4 text-sm sm:py-2.5 sm:px-8 sm:text-base md:px-14 md:text-lg lg:text-xl rounded-lg shadow-md transition-all duration-200 transform hover:-translate-y-1 active:scale-95 focus:outline-none flex-1 text-center";
