...
interface MainPageProps {
  currentLanguage: string; // or Language
...
function HomePage({ currentLanguage, setCurrentLanguage, getText }: MainPageProps) { // Component name is HomePage, but file is MainPage.js. Let's stick with HomePage.
  ...
  const cards: CardItem[] = [
    ...
    //       <path d="M9 2L7.17 4H4c-1.1 0-2 .9-2 2v1c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z"/>
    //     </svg>
    //   ),
